...
function Footer() {
  ...
  return (
      <div className="btm-nav">
          <button className="text-[#62CBC6]" onClick={() => changePage('home')}>
              <svg
          ...
          <button className="text-[#62CBC6] active" onClick={() => changePage('charge')}>
              <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6"
                  fill="currentColor"
          ...
          <button className="text-[#62CBC6]" onClick={() => changePage('receiptList')}>
              <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6"
                  fill="currentColor"
          ...
          <button className="text-[#62CBC6]" onClick={() => changePage('login')}>
              <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-6 w-6"
                  fill="currentColor"
